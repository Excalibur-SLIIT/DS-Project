...
class OrderDetailModule extends Component {
                                            ...
                                            <form>
                                                <div class="panel-body">
                                                    <div class="row group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control input-sm" name="country" required="" id="country" name="country" required="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <p>City</p>
                                                            <input type="text" class="form-control input-sm" name="city" required="" placeholder="" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <hr class="offset-sm visible-xs" />
                                                            <p>Street</p>
                                                            <input type="text" class="form-control input-sm" name="street" required="" placeholder="" />
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <hr class="offset-sm visible-xs" />
                                                            <p>Building</p>
                                                            <input type="text" class="form-control input-sm" name="bilding" required="" placeholder="" />
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <hr class="offset-sm visible-xs" />
                                                            <p>Zip</p>
                                                            <input type="text" class="form-control input-sm" name="zip" required="" placeholder="" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type="submit" class="address-submit-btn btn btn-primary btn-sm" value="Add Address"/>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="checkbox">
